...
function create_if_block(ctx) {
	...
	return {
		c: function create() {
			...
			pre = element("pre");
			t3 = text(ctx.failure);
			add_location(legend, file, 154, 4, 3492);
			add_location(pre, file, 155, 4, 3536);
			add_location(fieldset, file, 153, 2, 3477);
		},
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  let { key = null, path = '', props = null, exact = undefined, fallback = undefined, component = undefined, condition = undefined, redirect = undefined, nomount = undefined } = $$props;
  ...
  if (typeof window !== 'undefined') {
	...
	$$self.$set = $$new_props => {
		...
		if ('nomount' in $$props) $$invalidate('nomount', nomount = $$props.nomount);
...
class Route extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, ["key", "path", "props", "exact", "fallback", "component", "condition", "redirect", "nomount"]);
	}
